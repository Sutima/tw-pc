...
describe('Mask rendering', () => {
	...
	describe('Update DOM', () => {
		...
		it('should update mask list, showing owned, active and joined', () => {
			...
			assert.deepEqual(document.getElementById('mask-menu-mask-list').children.map(n => n.className), [
				undefined, undefined, undefined, undefined, undefined, undefined, 'active'
			]);
			assert.deepEqual(document.getElementById('mask-menu-mask-list').children.map(n => n.innerHTML), [
				...
				'<span class="mask" data-mask="96191857.1"><i data-icon="user" class="personal"></i>Private</span>',
				...
				'<span class="mask" data-mask="1.0"><i data-icon="user" class="personal"></i>Owned</span>',			
				'<span class="mask" data-mask="2.0"><i data-icon="user" class="personal"></i>Personal</span>',			
