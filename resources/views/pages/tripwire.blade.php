...
$result = collect(app('db')->select('SELECT solarSystemName, systems.solarSystemID, regionName, regions.regionID FROM '.$_ENV['EVE_DATABASE'].'.mapSolarSystems systems LEFT JOIN '.$_ENV['EVE_DATABASE'].'.mapRegions regions ON regions.regionID = systems.regionID WHERE solarSystemName = :system',
    ['system' => $_GET['system']]))->first();

if ($result) {
    $systemName = $result->solarSystemName;
    $systemID = $result->solarSystemID;
} else {
    $systemName = 'Jita';
    $systemID = 30000142;
}
...
<div id="topbar">
    <span class="align-left">
        <h1 id="logo" class="pointer">
            ...
            <?= $_ENV['APP_DEBUG'] ? '<span id="dev">Dev</span>' : '' ?>
    ...
    <ul>
        <li id="infoWidget" class="gridWidget" data-row="1" data-col="1" data-sizex="7" data-sizey="6" data-min-sizex="5" data-min-sizey="4" style="width: 410px; height: 350px;">
            <div class="content">
                ...
                <h1 id="infoSystem" class="pointer" style="color: #CCC;"><?= $systemName ?></h1>
...
<div id="footer">
    ...
    <?php printf("<span id='pageTime'>Page generated in %.3f seconds.</span>", 0); ?>
...
<!-- JS Includes -->
<script type="text/javascript" src="//<?= $_ENV['STATIC_HOST'] ?>/js/combine.js"></script>
<script type="text/javascript" src="//<?= $_ENV['STATIC_HOST'] ?>/ckeditor/ckeditor.js"></script>
<script type="text/javascript" src="//<?= $_ENV['STATIC_HOST'] ?>/js/dragscroll.js"></script>
<script type="text/javascript" src="//<?= $_ENV['STATIC_HOST'] ?>/js/core.js"></script>
<!-- JS Includes -->
