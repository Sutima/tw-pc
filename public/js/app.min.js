...
$("#dialog-masks").dialog({autoOpen:!1,width:450,minHeight:400,modal:!0,buttons:{Save:function(){var a=!1;options.masks.active!=$("#dialog-masks input[name='mask']:checked").val()&&(a=!0),options.masks.active=$("#dialog-masks input[name='mask']:checked").val(),options.save().done(function(){a&&($("#sigTable span[data-age]").countdown("destroy"),$("#sigTable tbody").empty(),$("#signature-count").html(0),tripwire.signatures.list={},tripwire.client.signatures=[],tripwire.refresh("change"))}),$(this).dialog("close"),document.getElementById("admin").disabled=!$("#dialog-masks input[name='mask']:checked").data("admin")},Close:function(){$(this).dialog("close")}},open:function(){$.ajax({url:"masks.php",type:"POST",dataType:"JSON"}).done(function(a){if(a&&a.masks){for(var e in $("#dialog-masks #masks #default").html(""),$("#dialog-masks #masks #personal").html(""),$("#dialog-masks #masks #corporate").html(""),a.masks){var i=a.masks[e],t=$('<input type="radio" name="mask" id="mask'+e+'" value="'+i.mask+'" class="selector" data-owner="'+i.owner+'" data-admin="'+i.admin+'" /><label for="mask'+e+'"><img src="'+i.img+'" />'+(i.optional?'<i class="closeIcon" onclick="return false;" data-icon="red-giant"><i data-icon="times"></i></i>':"")+'<span class="selector_label">'+i.label+"</span></label>");$("#dialog-masks #masks #"+i.type).append(t)}t=$('<input type="checkbox" name="find" id="findp" value="personal" class="selector" disabled="disabled" /><label for="findp"><i data-icon="search" style="font-size: 3em; margin-left: 16px; margin-top: 16px; display: block;"></i></label>');if($("#dialog-masks #masks #personal").append(t),"1"==init.admin){t=$('<input type="checkbox" name="find" id="findc" value="corporate" class="selector" disabled="disabled" /><label for="findc"><i data-icon="search" style="font-size: 3em; margin-left: 16px; margin-top: 16px; display: block;"></i></label>');$("#dialog-masks #masks #corporate").append(t)}$("#dialog-masks input[name='mask']").filter("[value='"+a.masks[a.active].mask+"']").attr("checked",!0).trigger("change"),document.getElementById("admin").disabled=!a.masks[a.active].admin}})}}),$("#mask-link").click(function(a){if(a.preventDefault(),$(this).hasClass("disabled"))return!1;$("#dialog-masks").dialog("open")}),$("#masks").on("change","input.selector:checked",function(){$(this).data("owner")?($("#maskControls #edit").removeAttr("disabled"),$("#maskControls #delete").removeAttr("disabled")):($("#maskControls #edit").attr("disabled","disabled"),$("#maskControls #delete").attr("disabled","disabled")),0!=$(this).val()&&0==$(this).val().split(".")[1]?$("#dialog-masks #leave").removeAttr("disabled"):$("#dialog-masks #leave").attr("disabled","disabled")}),$("#dialog-joinMask").dialog({autoOpen:!1,resizable:!1,dialogClass:"ui-dialog-shadow dialog-noeffect dialog-modal",buttons:{Add:function(){var a=$("#dialog-joinMask #results input:checked"),e=$("#dialog-joinMask #results input:checked+label");$.ajax({url:"masks.php",type:"POST",data:{mask:a.val(),mode:"join"},dataType:"JSON"}).done(function(i){i&&i.result&&(e.css("width",""),e.find(".info").remove(),e.append('<i class="closeIcon" onclick="return false;" data-icon="red-giant"><i data-icon="times"></i></i>'),$("#dialog-masks #masks #"+i.type+" input.selector:last").before(a).before(e),$("#dialog-joinMask").dialog("close"))})},Cancel:function(){$(this).dialog("close")}},create:function(){$("#dialog-joinMask form").submit(function(a){a.preventDefault(),$("#dialog-joinMask #results").html(""),$("#dialog-joinMask #loading").show(),$("#dialog-joinMask input[type='submit']").attr("disabled","disabled"),$.ajax({url:"masks.php",type:"POST",data:$(this).serialize(),dataType:"JSON"}).then(function(a){if(a&&a.results&&a.results.length)return tripwire.esi.fullLookup(a.eveIDs).done(function(e){if(e)for(var i in e){var t=a.results[i],s=$('<input type="radio" name="mask" id="mask'+t.mask+'" value="'+t.mask+'" class="selector" data-owner="false" data-admin="'+t.admin+'" /><label for="mask'+t.mask+'" style="width: 100%; margin-left: -5px;">\t<img src="'+t.img+'" />\t<span class="selector_label">'+t.label+'</span>\t<div class="info">\t\t'+e[i].name+"<br/>\t\t"+("character"==e[i].category?e[i].corporation.name+"<br/>":null)+"\t\t"+(e[i].alliance?e[i].alliance.name:"")+"<br/>\t</div></label>");$("#dialog-joinMask #results").append(s)}});a&&a.error?($("#dialog-error #msg").text(a.error),$("#dialog-error").dialog("open")):($("#dialog-error #msg").text("Unknown error"),$("#dialog-error").dialog("open"))}).then(function(){$("#dialog-joinMask #loading").hide(),$("#dialog-joinMask input[type='submit']").removeAttr("disabled")})})},close:function(){$("#dialog-joinMask #results").html(""),$("#dialog-joinMask input[name='name']").val("")}}),$("#dialog-masks #masks").on("click","input[name='find']+label",function(){$("#dialog-joinMask input[name='find']").val($(this).prev().val()),$("#dialog-joinMask").dialog("open")}),$("#dialog-masks #masks").on("click",".closeIcon",function(){var a=$(this).closest("input.selector+label").prev();$("#dialog-confirm #msg").text("Are you sure you want to remove this mask?"),$("#dialog-confirm").dialog("option",{buttons:{Remove:function(){var e={mode:"leave",mask:a.val()};$.ajax({url:"masks.php",type:"POST",data:e,dataType:"JSON"}).done(function(e){e&&e.result?(a.next().remove(),a.remove(),$("#dialog-confirm").dialog("close")):($("#dialog-confirm").dialog("close"),$("#dialog-error #msg").text("Unable to delete"),$("#dialog-error").dialog("open"))})},Cancel:function(){$(this).dialog("close")}}}).dialog("open")}),$("#maskControls #delete").click(function(){var a=$("#masks input.selector:checked");$("#dialog-confirm #msg").text("Are you sure you want to delete this mask?"),$("#dialog-confirm").dialog("option",{buttons:{Delete:function(){var e={mode:"delete",mask:a.val()};$.ajax({url:"masks.php",type:"POST",data:e,dataType:"JSON"}).done(function(e){e&&e.result?(a.next().remove(),a.remove(),$("#dialog-confirm").dialog("close")):($("#dialog-confirm").dialog("close"),$("#dialog-error #msg").text("Unable to delete"),$("#dialog-error").dialog("open"))})},Cancel:function(){$(this).dialog("close")}}}).dialog("open")}),$("#dialog-createMask").dialog({autoOpen:!1,dialogClass:"ui-dialog-shadow dialog-noeffect dialog-modal",buttons:{Create:function(){$("#dialog-createMask form").submit()},Cancel:function(){$(this).dialog("close")}},create:function(){$("#dialog-createMask #accessList").on("click","#create_add+label",function(){$("#dialog-EVEsearch").dialog("open")}),$("#dialog-createMask form").submit(function(a){a.preventDefault(),$.ajax({url:"masks.php",type:"POST",data:$(this).serialize(),dataType:"JSON"}).done(function(a){a&&a.result?($.ajax({url:"masks.php",type:"POST",dataType:"JSON"}).done(function(a){if(a&&a.masks){for(var e in $("#dialog-masks #masks #default").html(""),$("#dialog-masks #masks #personal").html(""),$("#dialog-masks #masks #corporate").html(""),a.masks){var i=a.masks[e],t=$('<input type="radio" name="mask" id="mask'+e+'" value="'+i.mask+'" class="selector" data-owner="'+i.owner+'" data-admin="'+i.admin+'" /><label for="mask'+e+'"><img src="'+i.img+'" />'+(i.optional?'<i class="closeIcon" onclick="return false;" data-icon="red-giant"><i data-icon="times"></i></i>':"")+'<span class="selector_label">'+i.label+"</span></label>");$("#dialog-masks #masks #"+i.type).append(t)}t=$('<input type="checkbox" name="find" id="findp" value="personal" class="selector" disabled="disabled" /><label for="findp"><i data-icon="search" style="font-size: 3em; margin-left: 16px; margin-top: 16px; display: block;"></i></label>');if($("#dialog-masks #masks #personal").append(t),"1"==init.admin){t=$('<input type="checkbox" name="find" id="findc" value="corporate" class="selector" disabled="disabled" /><label for="findc"><i data-icon="search" style="font-size: 3em; margin-left: 16px; margin-top: 16px; display: block;"></i></label>');$("#dialog-masks #masks #corporate").append(t)}$("#dialog-masks input[name='mask']").filter("[value='"+a.masks[a.active].mask+"']").attr("checked",!0).trigger("change"),document.getElementById("admin").disabled=!a.masks[a.active].admin}}),$("#dialog-createMask").dialog("close")):a&&a.error?($("#dialog-error #msg").text(a.error),$("#dialog-error").dialog("open")):($("#dialog-error #msg").text("Unknown error"),$("#dialog-error").dialog("open"))})}),$("#dialog-createMask select").selectmenu({width:100})},open:function(){$("#dialog-createMask input[name='name']").val(""),$("#dialog-createMask #accessList :not(.static)").remove()}}),$("#maskControls #create").click(function(){$("#dialog-createMask").dialog("open")}),$("#dialog-createMask #accessList").on("click",".maskRemove",function(){$(this).closest("input.selector+label").prev().remove(),$(this).closest("label").remove()}),$("#dialog-editMask").dialog({autoOpen:!1,dialogClass:"ui-dialog-shadow dialog-noeffect dialog-modal",buttons:{Save:function(){$("#dialog-editMask form").submit()},Cancel:function(){$(this).dialog("close")}},create:function(){$("#dialog-editMask #accessList").on("click",".maskRemove",function(){$(this).closest("input.selector+label").prev().attr("name","deletes[]").hide(),$(this).closest("label").hide()}),$("#dialog-editMask #accessList").on("click","#edit_add+label",function(){$("#dialog-EVEsearch").dialog("open")}),$("#dialog-editMask form").submit(function(a){a.preventDefault(),$.ajax({url:"masks.php",type:"POST",data:$(this).serialize(),dataType:"JSON"}).done(function(a){a&&a.result?$("#dialog-editMask").dialog("close"):a&&a.error?($("#dialog-error #msg").text(a.error),$("#dialog-error").dialog("open")):($("#dialog-error #msg").text("Unknown error"),$("#dialog-error").dialog("open"))})})},open:function(){var a=$("#dialog-masks input[name='mask']:checked").val();$("#dialog-editMask input[name='mask']").val(a),$("#dialog-editMask #accessList label.static").hide(),$("#dialog-editMask #loading").show(),$("#dialog-editMask #name").text($("#dialog-masks input[name='mask']:checked+label .selector_label").text()),$.ajax({url:"masks.php",type:"POST",data:{mode:"edit",mask:a},dataType:"JSON"}).then(function(a){if(a&&a.results&&a.results.length)return tripwire.esi.fullLookup(a.results).done(function(a){if(a)for(var e in a)if("character"==a[e].category){var i=$('<input type="checkbox" checked="checked" onclick="return false" name="" id="edit_'+a[e].id+'_1373" value="'+a[e].id+'_1373" class="selector" /><label for="edit_'+a[e].id+'_1373">\t<img src="https://image.eveonline.com/Character/'+a[e].id+'_64.jpg" />\t<span class="selector_label">Character</span>\t<div class="info">\t\t'+a[e].name+"<br/>\t\t"+a[e].corporation.name+"<br/>\t\t"+(a[e].alliance?a[e].alliance.name:"")+'<br/>\t\t<input type="button" class="maskRemove" value="Remove" style="position: absolute; bottom: 3px; right: 3px;" />\t</div></label>');$("#dialog-editMask #accessList .static:first").before(i)}else if("corporation"==a[e].category){i=$('<input type="checkbox" checked="checked" onclick="return false" name="" id="edit_'+a[e].id+'_2" value="'+a[e].id+'_2" class="selector" /><label for="edit_'+a[e].id+'_2">\t<img src="https://image.eveonline.com/Corporation/'+a[e].id+'_64.png" />\t<span class="selector_label">Corporation</span>\t<div class="info">\t\t'+a[e].name+"<br/>\t\t"+(a[e].alliance?a[e].alliance.name:"")+'<br/>\t\t<input type="button" class="maskRemove" value="Remove" style="position: absolute; bottom: 3px; right: 3px;" />\t</div></label>');$("#dialog-editMask #accessList .static:first").before(i)}})}).then(function(a){$("#dialog-editMask #accessList label.static").show(),$("#dialog-editMask #loading").hide()})},close:function(){$("#dialog-editMask #accessList :not(.static)").remove()}}),$("#dialog-EVEsearch").dialog({autoOpen:!1,dialogClass:"ui-dialog-shadow dialog-noeffect dialog-modal",buttons:{Add:function(){if($("#accessList input[value='"+$("#EVESearchResults input").val()+"']").length)return $("#dialog-error #msg").text("Already has access"),$("#dialog-error").dialog("open"),!1;$("#EVESearchResults .info").append('<input type="button" class="maskRemove" value="Remove" style="position: absolute; bottom: 3px; right: 3px;" />'),$("#EVESearchResults input:checked").attr("checked","checked"),$("#EVESearchResults input:checked").attr("onclick","return false");var a=$("#EVESearchResults .maskNode:has(input:checked)");$("#dialog-createMask").dialog("isOpen")?$("#dialog-createMask #accessList .static:first").before(a):$("#dialog-editMask").dialog("isOpen")&&$("#dialog-editMask #accessList .static:first").before(a),$(this).dialog("close")},Close:function(){$(this).dialog("close")}},create:function(){$("#EVEsearch").submit(function(a){if(a.preventDefault(),""==$("#EVEsearch input[name='name']").val())return!1;$("#EVESearchResults, #searchCount").html(""),$("#EVEsearch #searchSpinner").show(),$("#EVEsearch input[type='submit']").attr("disabled","disabled"),$("#dialog-EVEsearch").parent().find(".ui-dialog-buttonpane button:contains('Add')").attr("disabled",!0).addClass("ui-state-disabled"),tripwire.esi.search($("#EVEsearch input[name='name']").val(),$("#EVEsearch input[name='category']:checked").val(),$("#EVEsearch input[name='exact']")[0].checked).done(function(a){if(a&&(a.character||a.corporation))return a=$.merge(a.character||[],a.corporation||[]),total=a.length,a=a.slice(0,10),tripwire.esi.fullLookup(a).done(function(a){if($("#EVEsearch #searchCount").html("Found: "+total+"<br/>Showing: "+(total<10?total:10)),a)for(var e in a)if("character"==a[e].category){var i=$('<div class="maskNode"><input type="checkbox" name="adds[]" id="find_'+a[e].id+'_1373" value="'+a[e].id+'_1373" class="selector" /><label for="find_'+a[e].id+'_1373">\t<img src="https://image.eveonline.com/Character/'+a[e].id+'_64.jpg" />\t<span class="selector_label">Character</span>\t<div class="info">\t\t'+a[e].name+"<br/>\t\t"+a[e].corporation.name+"<br/>\t\t"+(a[e].alliance?a[e].alliance.name:"")+"<br/>\t</div></label></div>");$("#EVESearchResults").append(i)}else if("corporation"==a[e].category){i=$('<div class="maskNode"><input type="checkbox" name="adds[]" id="find_'+a[e].id+'_2" value="'+a[e].id+'_2" class="selector" /><label for="find_'+a[e].id+'_2">\t<img src="https://image.eveonline.com/Corporation/'+a[e].id+'_64.png" />\t<span class="selector_label">Corporation</span>\t<div class="info">\t\t'+a[e].name+"<br/>\t\t"+(a[e].alliance?a[e].alliance.name:"")+"<br/>\t</div></label></div>");$("#EVESearchResults").append(i)}}).always(function(){$("#EVEsearch #searchSpinner").hide(),$("#EVEsearch input[type='submit']").removeAttr("disabled"),$("#dialog-EVEsearch").parent().find(".ui-dialog-buttonpane button:contains('Add')").removeAttr("disabled").removeClass("ui-state-disabled")});$("#dialog-error #msg").text("No Results"),$("#dialog-error").dialog("open"),$("#EVEsearch #searchSpinner").hide(),$("#EVEsearch input[type='submit']").removeAttr("disabled"),$("#dialog-EVEsearch").parent().find(".ui-dialog-buttonpane button:contains('Add')").removeAttr("disabled").removeClass("ui-state-disabled")})})},close:function(){$("#EVEsearch input[name='name']").val(""),$("#EVESearchResults, #searchCount").html("")}}),$("#maskControls #edit").click(function(){$("#dialog-editMask").dialog("open")});
